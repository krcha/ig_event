...
export const DEFAULT_FOLLOW_DISCOVERY_RESULTS_LIMIT = 2000;
export const MIN_FOLLOW_DISCOVERY_RESULTS_LIMIT = 50;
export const MAX_FOLLOW_DISCOVERY_RESULTS_LIMIT = 2000;
export const DEFAULT_FOLLOW_DISCOVERY_MAX_TOTAL_CHARGE_USD = 1.5;
